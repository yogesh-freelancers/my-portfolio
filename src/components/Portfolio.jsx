...
const PROJECTS = [
  {
    id:1, num:"01", title:"Rohangems", subtitle:"Diamond & Jewelry Management System",
  ...
  {
    id:2, num:"02", title:"Library Management System", subtitle:"Role-Based Institutional Platform",
  ...
  {
    id:3, num:"03", title:"Inventory Management System", subtitle:"Multi-Warehouse Stock Platform",
...
const ROLES = ["Java Backend Developer","Full Stack Developer","Spring Boot Specialist","REST API Engineer","Microservices Enthusiast","Problem Solver"];
      ...
      <motion.div initial={{scale:0.87,y:40,opacity:0}} animate={{scale:1,y:0,opacity:1}} exit={{scale:0.9,y:20,opacity:0}} transition={{type:"spring",stiffness:280,damping:26}}
        ...
        <div style={{padding:"14px 18px",borderBottom:`1px solid ${t.cardB}`,display:"flex",alignItems:"center",justifyContent:"space-between",gap:10,position:"sticky",top:0,background:t.bg,zIndex:10}}>
          <div style={{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}}>
            ...
            <span style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:800,fontSize:"0.95rem",color:t.text}}>{p.title}</span>
          ...
          <div style={{borderRadius:14,overflow:"hidden",background:`${p.color}10`,border:`1px solid ${p.color}25`,position:"relative",height:180,marginBottom:"16px",userSelect:"none"}}
            ...
            <AnimatePresence mode="wait">
              <motion.div key={slide} initial={{opacity:0,x:45}} animate={{opacity:1,x:0}} exit={{opacity:0,x:-45}} transition={{duration:0.28}}
                ...
                <p style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:700,color:p.color,fontSize:"0.92rem"}}>{p.slides[slide].label}</p>
  ...
  return (
    <motion.nav initial={{y:-60,opacity:0}} animate={{y:0,opacity:1}} transition={{duration:0.5}}
      ...
      <div style={{maxWidth:1160,margin:"0 auto",padding:"0 20px",height:60,display:"flex",alignItems:"center",justifyContent:"space-between"}}>
        <a href="#hero" style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:900,fontSize:"1.2rem",color:t.text,textDecoration:"none"}}>YK<span style={{color:t.accent}}>.</span></a>
    ...
    <section id="hero" style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",position:"relative",overflow:"hidden",paddingTop:70}}>
      ...
      <motion.div style={{opacity:op,position:"relative",zIndex:1,textAlign:"center",width:"100%",maxWidth:840,padding:"0 20px",boxSizing:"border-box"}}>
        ...
        <motion.p initial={{opacity:0,y:14}} animate={{opacity:1,y:0}} transition={{delay:0.17}}
          style={{fontSize:"clamp(0.88rem,2.5vw,1rem)",color:t.muted,marginBottom:8,fontWeight:300,display:"flex",alignItems:"center",justifyContent:"center",gap:7}}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={{color:t.accent}}>
    ...
    <div style={{maxWidth:1100,margin:"0 auto"}}>
      <div className="about-grid">
        <Rev dir="left">
          <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:26}}>
            <div style={{position:"relative"}}>
              <div style={{width:190,height:190,borderRadius:26,background:`linear-gradient(135deg,${t.accentDim},rgba(37,99,235,0.14))`,border:`2px solid ${t.accentB}`,display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Plus Jakarta Sans',sans-serif",fontSize:"3.2rem",fontWeight:900,color:t.accent,boxShadow:`0 0 48px ${t.accent}22`,position:"relative"}}>
                YK
              ...
              <motion.div animate={{y:[-4,4,-4]}} transition={{repeat:Infinity,duration:2.8}}
                style={{position:"absolute",bottom:-12,right:-14,padding:"7px 13px",borderRadius:10,background:t.accentDim,border:`1px solid ${t.accentB}`,fontSize:"0.7rem",fontWeight:700,color:t.accent,backdropFilter:"blur(8px)",whiteSpace:"nowrap",display:"flex",alignItems:"center",gap:5}}>
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></svg>
                Open to Work
              </motion.div>
            </div>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:9,width:"100%",maxWidth:290}}>
              {STATS.map((s,i)=>(
                <motion.div key={s.label} initial={{opacity:0,scale:0.85}} whileInView={{opacity:1,scale:1}} viewport={{once:true}} transition={{delay:i*0.08}} whileHover={{scale:1.04}}
                  ...
                  <div style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:800,fontSize:"1.25rem",color:t.accent,lineHeight:1}}>{s.value}</div>
        ...
        <Rev dir="right" delay={0.1}>
          ...
          <h2 style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:800,fontSize:"clamp(1.65rem,4vw,2.4rem)",lineHeight:1.15,color:t.text,marginBottom:18,letterSpacing:"-0.02em"}}>Turning complexity<br/>into clean architecture</h2>
    ...
    <div style={{maxWidth:1100,margin:"0 auto"}}>
      <Rev>
        <div style={{textAlign:"center",maxWidth:460,margin:"0 auto 46px"}}>
          ...
          <h2 style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:800,fontSize:"clamp(1.75rem,4vw,2.6rem)",color:t.text,letterSpacing:"-0.02em",marginBottom:8}}>My arsenal</h2>
      ...
      <div className="skills-grid">
        {SKILLS.map((sk,i)=>(
          <motion.div key={sk.name} initial={{opacity:0,y:18}} whileInView={{opacity:1,y:0}} viewport={{once:true}} transition={{delay:i*0.045}}
            ...
            <div style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:700,fontSize:"0.78rem",color:t.text,marginBottom:9}}>{sk.name}</div>
      ...
      <div style={{maxWidth:1100,margin:"0 auto"}}>
        <Rev>
          <div style={{textAlign:"center",maxWidth:500,margin:"0 auto 46px"}}>
            ...
            <h2 style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:800,fontSize:"clamp(1.75rem,4vw,2.6rem)",color:t.text,letterSpacing:"-0.02em",marginBottom:8}}>Things I've built</h2>
          ...
          {PROJECTS.map((p,i)=>(
            <motion.div key={p.id} initial={{opacity:0,y:34}} whileInView={{opacity:1,y:0}} viewport={{once:true}} transition={{delay:i*0.11}}
              ...
              <div style={{padding:"22px 20px",display:"flex",flexDirection:"column",flex:1}}>
                ...
                <h3 style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:800,fontSize:"1.1rem",color:t.text,marginBottom:3,lineHeight:1.2}}>{p.title}</h3>
    ...
    <div style={{maxWidth:1100,margin:"0 auto"}}>
      <Rev>
        <div style={{textAlign:"center",maxWidth:480,margin:"0 auto 46px"}}>
          ...
          <h2 style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:800,fontSize:"clamp(1.75rem,4vw,2.6rem)",color:t.text,letterSpacing:"-0.02em",marginBottom:8}}>What I've achieved</h2>
      ...
      <div className="milestones-grid">
        {ACHIEVEMENTS.map((a,i)=>(
          <motion.div key={a.title} initial={{opacity:0,y:22}} whileInView={{opacity:1,y:0}} viewport={{once:true}} transition={{delay:(i%4)*0.07}}
            ...
            <h3 style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:800,fontSize:"0.88rem",color:t.text,marginBottom:5,lineHeight:1.3}}>{a.title}</h3>
      ...
      <div style={{maxWidth:1100,margin:"0 auto"}}>
        <Rev>
          <div style={{textAlign:"center",maxWidth:480,margin:"0 auto 46px"}}>
            ...
            <h2 style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:800,fontSize:"clamp(1.75rem,4vw,2.6rem)",color:t.text,letterSpacing:"-0.02em",marginBottom:8}}>Let's build together</h2>
            ...
            <div style={{padding:"26px 22px",borderRadius:20,background:t.card,border:`1px solid ${t.cardB}`}}>
              {state==="done"?(
                <motion.div initial={{opacity:0,scale:0.86}} animate={{opacity:1,scale:1}} style={{textAlign:"center",padding:"28px 0"}}>
                  ...
                  <h3 style={{fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:800,fontSize:"1.1rem",color:t.text,marginBottom:5}}>Message Sent!</h3>
...
const Footer = ({t}) => (
  <footer style={{padding:"22px 20px",borderTop:`1px solid ${t.cardB}`}}>
    <div style={{maxWidth:1100,margin:"0 auto",display:"flex",flexWrap:"wrap",gap:10,alignItems:"center",justifyContent:"space-between"}}>
      <span style={{fontSize:"0.76rem",fontWeight:600,color:t.sub}}>© 2026 Yogesh Kumar Chaturvedi</span>
      <span style={{fontSize:"0.76rem",color:t.sub,display:"flex",alignItems:"center",gap:6}}>
        <span style={{display:"inline-flex",alignItems:"center",gap:4}}>
          Built with
          <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" stroke="none" style={{color:"#f472b6"}}><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
        </span>
        <span style={{color:t.sub,opacity:0.4}}>·</span>
        <span style={{display:"inline-flex",alignItems:"center",gap:4}}>
          Open to opportunities
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{color:t.accent}}><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
        </span>
      </span>
    </div>
  </footer>
...
export default function App() {
  ...
  return (
    <div style={{minHeight:"100vh",background:t.bg,color:t.text,transition:"background 0.4s ease,color 0.3s ease",overflowX:"hidden"}}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=JetBrains+Mono:wght@400;600&family=Inter:wght@300;400;500;600&display=swap');
        *{box-sizing:border-box;margin:0;padding:0;}
        html{scroll-behavior:smooth;}
        body{font-family:'Inter',sans-serif;overflow-x:hidden;}

        /* ── GRADIENT NAME — CSS class (works on all mobile browsers) ── */
        .hero-name-top {
